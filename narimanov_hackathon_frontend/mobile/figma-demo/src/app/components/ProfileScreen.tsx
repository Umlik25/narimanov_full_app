...
export function ProfileScreen({ role, onBack, onLogout, onSwitchRole, userName }: Props) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F5F7FB]">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <span
              ...
              style={{
                background: role === 'admin' ? '#7C3AED' : '#0B5CFF',
                color: 'white',
                fontFamily: 'Inter, sans-serif', fontWeight: 600,
              }}
            >
              {role === 'admin' ? '🛡️ District Admin' : '👤 Citizen User'}
            </span>
          </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
        ...
        <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm">
          ...
          {[
            ...
            { icon: <Shield size={16} />, label: 'Role', value: role === 'admin' ? 'District Administrator' : 'Citizen User' },
        ...
        {/* Switch role (demo) */}
        <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm">
          <p className="text-gray-500 text-xs mb-3" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600 }}>DEMO MODE — SWITCH ROLE</p>
          <div className="flex gap-3">
            <motion.button
              ...
              style={{
                borderColor: role === 'user' ? '#0B5CFF' : '#E5E7EB',
                background: role === 'user' ? '#EEF3FF' : 'white',
                color: role === 'user' ? '#0B5CFF' : '#6B7280',
                fontFamily: 'Inter, sans-serif', fontWeight: 600,
              }}
            >
              👤 User
            ...
            <motion.button
              ...
              style={{
                ...
                background: role === 'admin' ? '#EDE9FE' : 'white',
      ...
      {editOpen && (
        <Sheet onClose={() => setEditOpen(false)} title="Edit profile" subtitle="Update demo account details.">
      ...
      {notificationsOpen && (
        <Sheet onClose={() => setNotificationsOpen(false)} title="Notifications" subtitle="Choose the alerts you want to receive.">
          {[
            ['Report updates', 'Status changes and admin comments', reportAlerts, setReportAlerts],
            ['Reward updates', 'New points, coupons, and redemptions', rewardAlerts, setRewardAlerts],
