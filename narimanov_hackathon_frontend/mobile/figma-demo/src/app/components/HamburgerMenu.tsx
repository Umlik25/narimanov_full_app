import { X, Map, Plus, FileText, Bot, User, LogOut, Eye, List, BarChart2, Settings, MapPin, ChevronRight, Gift } from "lucide-react";
...
const userGroups: NavItem[][] = [
  ...
  [
    { icon: <Plus size={16} />, label: 'Report Issue', screen: 'report_issue', color: '#16A34A', bg: '#EDFAF3' },
...
const adminGroups: NavItem[][] = [
  [
    { icon: <Map size={16} />, label: 'Map', screen: 'admin_map', color: '#0B5CFF', bg: '#EEF3FF' },
  ],
  [
    { icon: <Eye size={16} />, label: 'AI Review', screen: 'admin_ai_review', color: '#7C3AED', bg: '#F3EEFF' },
    { icon: <List size={16} />, label: 'All Issues', screen: 'admin_all_issues', color: '#0B5CFF', bg: '#EEF3FF' },
    { icon: <Settings size={16} />, label: 'Operations', screen: 'admin_operations', color: '#F97316', bg: '#FFF4ED' },
    { icon: <BarChart2 size={16} />, label: 'Analytics', screen: 'admin_analytics', color: '#16A34A', bg: '#EDFAF3' },
  ],
  [
    { icon: <Bot size={16} />, label: 'AI Assistant', screen: 'ai_chat', color: '#7C3AED', bg: '#F3EEFF' },
    { icon: <User size={16} />, label: 'Profile', screen: 'profile', color: '#6B7280', bg: '#F3F4F6' },
...
export function HamburgerMenu({ role, currentScreen, onNavigate, onClose, onLogout, userName }: Props) {
  const groups = role === 'user' ? userGroups : adminGroups;
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 3 }}>
                <span style={{
                  ...
                  background: role === 'admin' ? "linear-gradient(135deg,#7C3AED,#5B21B6)" : "linear-gradient(135deg,#0B5CFF,#1a3a8f)",
